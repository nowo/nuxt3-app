<template>
  <!-- <LoginBaseMain /> -->
  <div class="flex items-center justify-center h100vh">
    <el-form ref="formRef" :model="ruleForm" :rules="rules" size="large" class="login-content-form"
      @submit.prevent="onLogin">
      <el-form-item prop="userName">
        <el-input v-model.trim="ruleForm.userName" type="text" maxlength="20" placeholder="请输入账号" autofocus clearable
          tabindex="1" @keyup.enter="onLogin">
          <template #prefix>
            <i class="i-ep-user" />
          </template>
        </el-input>
